# Python_Practice & Semiconductor Data Analysis

此 Repository 用於紀錄我的 Python 學習與資料分析歷程。

目前的學習目標除了熟悉 Python 語法，也希望逐步將 Python、NumPy、Pandas 與 Matplotlib 應用於工程與半導體製程資料分析，
並作為後續專題的基礎。
